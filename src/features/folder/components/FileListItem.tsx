// src/features/folder/components/FileListItem.tsx
...
export default function FileListItem({
  ...
  // ── Dynamic Color Logic ──
  const getItemColor = () => {
    if (!isFile && doc) return doc.color;
  ...
  return (
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            boxShadow: `2px 0 8px ${itemColor}80`,
          }}
        />
        ...
        <div className="flex items-center gap-3.5 pl-2 overflow-hidden">
          ...
          <div className="flex flex-col truncate pr-2">
            ...
            <p className="text-[11px] sm:text-[12px] font-medium text-slate-400 dark:text-slate-500 flex items-center gap-1.5 mt-0.5">
              ...
              />
              {file && (
                <span>{(file.sizeBytes / 1024).toFixed(1)} KB &middot; </span>
              )}
              <span>
        ...
        <div className="flex items-center gap-1.5 shrink-0 pl-2">
          ...
          <div ref={menuRef} className="relative ml-0.5 sm:ml-1">
            <button
              onClick={toggleMenu}
              className={`w-8 h-8 flex items-center justify-center rounded-xl border transition-all shadow-sm opacity-90 hover:opacity-100 ${
                showMenu
      ...
      <VerifyPinModal
        ...
        description={`Enter your Master PIN to safely open this encrypted ${itemType}.`}
      />
    </>
  );
}
