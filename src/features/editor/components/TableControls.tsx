          ...
          {!isTableActive ? (
            <div className="flex flex-col gap-2 p-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1 flex flex-col gap-1">
                  <label className="text-[10px] font-bold text-slate-400 flex items-center gap-1">
                    <Columns className="w-3 h-3" /> Cols
                  </label>
                  <input
                    type="number"
                    min="1"
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <div className="grid grid-cols-2 gap-1 mb-1">
                <button
                  ...
                  className="flex items-center gap-2 px-2 py-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-xs font-semibold text-slate-700 dark:text-slate-300 transition-colors"
                >
                  <ArrowUpToLine className="w-3.5 h-3.5 text-indigo-500" /> Row
                  Above
                </button>
                <button
                  onClick={() => {
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-2 py-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-xs font-semibold text-slate-700 dark:text-slate-300 transition-colors"
                >
                  <ArrowLeftToLine className="w-3.5 h-3.5 text-indigo-500" />{" "}
                  Col Left
                </button>
                <button
                  onClick={() => {
                  ...
                  className="flex items-center gap-2 px-2 py-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg text-xs font-semibold text-slate-700 dark:text-slate-300 transition-colors"
                >
                  <ArrowRightToLine className="w-3.5 h-3.5 text-indigo-500" />{" "}
                  Col Right
                </button>
              </div>
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg text-xs font-semibold text-red-600 dark:text-red-400 transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg text-xs font-bold text-red-600 dark:text-red-500 transition-colors mt-1 bg-red-50 dark:bg-red-500/5"
              >
